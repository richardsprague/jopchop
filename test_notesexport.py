...
class TestNotesExport(unittest.TestCase):
    ...
    def test_export_notes(self):
        ...
        self.assertEqual(results,'<div id="Notes 200711 Tuesday" class="raw"><p class="date-box">Saturday, July 11</p></div>Second Note\n\nwith a link to [Notes 200710 Monday](#Notes 200710 Monday)<div class="raw"><p class="date-box">Notes Something else</p></div>Here\'s the third note\n<div id="Notes 200712 Wednesday" class="raw"><p class="date-box">Sunday, July 12</p></div><div id="Notes 200710 Monday" class="raw"><p class="date-box">Friday, July 10</p></div>This is the first note\n\nlinks to [Notes 200712 Wednesday](#Notes 200712 Wednesday)')
